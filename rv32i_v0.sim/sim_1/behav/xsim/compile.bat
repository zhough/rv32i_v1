...
REM
REM Generated by Vivado on Thu Mar 26 13:39:51 +0800 2026
...
echo "xvlog --incr --relax -prj top1_tb_vlog.prj"
call xvlog  --incr --relax -prj top1_tb_vlog.prj -log xvlog.log
