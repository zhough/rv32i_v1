...
#
# Script generated by Vivado on Sun Mar 22 02:40:57 +0800 2026
...
#
# Usage        : ram8x4.sh
#                ram8x4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram8x4.sh [-rerun]
#                ram8x4.sh [-reset_run]
#                ram8x4.sh [-clean]
#                ram8x4.sh [-reset_log]
...
# script info
echo -e "ram8x4.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram8x4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram8x4 xil_defaultlib.ram8x4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram8x4 -key {Behavioral:sim_1:Functional:ram8x4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram8x4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram8x4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram8x4.sh [-help]\n\
Usage: ram8x4.sh [-step]\n\
Usage: ram8x4.sh [-lib_map_path]\n\
Usage: ram8x4.sh [-rerun]\n\
Usage: ram8x4.sh [-reset_run]\n\
Usage: ram8x4.sh [-clean]\n\
Usage: ram8x4.sh [-reset_log]\n\
Usage: ram8x4.sh [-keep_index]\n\
Usage: ram8x4.sh [-noclean_files]\n\n\
