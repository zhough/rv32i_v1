...
HD_PWD='E:/Vivado_code/rv32i_v0/rv32i_v0.runs/ram8x4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram8x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram8x4.tcl
